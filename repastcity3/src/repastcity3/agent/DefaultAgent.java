...
public class DefaultAgent implements IAgent {
	...
	//==========================================================Tahina ===============================================
		...
		private Coordinate currentCoords = null;
		private ArrayList<Coordinate> agentPath=new ArrayList<Coordinate>();//ArrayList that content the trajectory of the agent
		private ArrayList<Instant> allTimeStamps=new ArrayList<Instant>();//ArrayList of all timestamp

		//================================================================================================================

		public ArrayList<Coordinate> getAgentPath() {
			return agentPath;
		}

		public void setAgentPath(ArrayList<Coordinate> agentPath) {
			this.agentPath = agentPath;
		}

		public ArrayList<Instant> getAllTimeStamps() {
			return allTimeStamps;
		}

		public void setAllTimeStamps(ArrayList<Instant> allTimeStamps) {
	...
	public void step() throws Exception {
		...
		if (!this.route.atDestination()) {
			...
			//===========================================Tahina======================================
			currentCoords=ContextManager.getAgentGeography().getGeometry(this).getCoordinate();
			this.allTimeStamps.add(Instant.now());//store the current timestamp
			this.agentPath.add(currentCoords);//store the current coordinates
			//=============================================Tahina ===============================================
		} else {
